...
if (isset($_POST['input_cellphone'])) $cellphone = $_POST['input_cellphone'];
else $input_cellphone = '';
if (isset($_POST['input_age'])) {
   $age = $_POST['input_age'];
}
if (isset($_POST['input_birthdate'])) {
   $birthdate = $_POST['input_birthdate'];
}
if (isset($_POST['input_level_id'])) {
   $level_id = $_POST['input_level_id'];
}
if (isset($_POST['input_disability_id'])) {
   $disability_id = $_POST['input_disability_id'];
}
...
if (isset($_POST['input_languages'])) {
   $languages = $_POST['input_languages'];
}
...
if (isset($_POST['input_enable'])) {
   $enable = $_POST['input_enable'];
}
