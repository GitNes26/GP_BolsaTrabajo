...
<body class="layout-top-nav layout-footer-fixed layout-navbar-fixed layout-fixed sidebar-mini-md sidebar-mini sidebar-mini-xs">
               ...
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class='nav-item'>
                     <div class='user-panel d-flex'>
                        <div class='info'>
                           <span class='d-block text-decoration-none text-bold text-light'><i class=''><?= isset($_COOKIE["email"])
                                                                                                            ? $_COOKIE["email"]
                  ...
                  <div id="div_company" class="">
                     ...
                     <div class="row">
                        ...
                        <div class="mb-3 col">
                           ...
                           <select class="select2 form-control" style="width:100%" id="input_business_line_id" name="input_business_line_id" data-input-name="GIRO">
                           </select>
                        </div>
                        <div class="mb-3 col">
                           <label for="input_company_ranking_id" class="form-label">Clasificacón: <span class="obligatory"></span></label>
                           <select class="select2 form-control" style="width:100%" id="input_company_ranking_id" name="input_company_ranking_id" data-input-name="ACERCA DE">
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col">
                           ...
                           <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                 <label for="input_birthdate" class="form-label">Fecha de Nacimiento: <span class="obligatory"></span></label>
                                 <input type="date" class="form-control not_validate" id="input_birthdate" name="input_birthdate" data-input-name="FECHA DE NACIMIENTO">
                     ...
                     <div class="border rounded mt-2 p-2">
                        ...
                        <div class="row">
                           <div class="mb-3 col">
                              ...
                              <select class="select2 form-control not_validate" style="width:100%; line-height:10px" id="input_profession_id" name="input_profession_id" data-input-name="PROFESIÓN">
                              </select>
                           </div>
                        </div>
