...
<div class="content-wrapper text-sm">
      ...
      <?php if ($_COOKIE["role_id"] == 3) : ?>
         ...
         <form class="content" id="form">
            <div class="card card-widget widget-user shadow">
               ...
               <div class="widget-user-header bg-dark" id="div_header">
                  <h3 class="widget-user-username im_output" title="" id="output_company">[Mi Comañia]</h3>
                  <input type="text" class="form-control-border-white text-white text-center d-none im_input"
                     title="[Enter] para siguiente" id="input_company" name="input_company" data-input-name="COMPAÑIA">
                  <h5 class="widget-user-desc im_output" id="output_location">[C.P, Ciudad, Estado]</h5>
                  <div class="mt-2 d-none im_input">
                     <div class="row justify-content-center">
                        ...
                        <input type="text" maxlength="5" style="width:10vw;" class="form-control form-control-sm numeric"
                           id="input_zip" name="input_zip" data-input-name="CÓDIGO POSTAL">
                        ...
                        <select class="select2 form-control" style="width:15vw; line-height:10px" id="input_state"
                     ...
                     class="reload_input">&nbsp;&nbsp;<i class="fa-light fa-arrows-rotate pointer"></i></span> -->
                        <select class="select2 form-control" style="width:15vw; line-height:10px" id="input_municipality"
                           name="input_municipality" data-input-name="MUNICIPIO" disabled>
                        </select>
                        <!-- <span title="dar click aqui si no se cargan los datos." data-input="input_state" class="reload_input">&nbsp;&nbsp;<i class="fa-light fa-arrows-rotate pointer"></i></span> -->
                        <select class="select2 form-control" style="width:15vw; line-height:10px" id="input_colony"
                           name="input_colony" data-input-name="COLONIA">
                        </select>
                     </div>
               ...
               <div class="widget-user-image">
                  <label for="input_logo_path">
                     <div id="preview_logo" class="d-flex justify-content-center">
                        <img class="img-circle elevation-2 bg-white pointer-sm opacity-100 d-none" id="output_logo"
                           src="../assets/img/cargar_imagen.png" alt="Foto de perfil" for="input_logo_path"
                           title="Haz clic aquí, si deseas cambiar tu logo">
                     </div>
                  </label>
               </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3 border-right">
                        <div class="description-block">
                           ...
                           <input type="text" class="form-control-border text-white text-center d-none im_input"
                              title="[Enter] para siguiente" id="input_contact_name" name="input_contact_name"
                     ...
                     <div class="col-sm-3 border-right">
                        <div class="description-block">
                           ...
                           <input type="text" class="form-control-border text-white text-center d-none im_input"
                              title="[Enter] para siguiente" id="input_contact_phone" name="input_contact_phone"
                              data-input-name="TELEFONO DE CONTACTO">
                     ...
                     <div class="col-sm-3 border-right">
                        <div class="description-block">
                           ...
                           <input type="text" class="form-control-border text-white text-center d-none im_input"
                              title="[Enter] para siguiente" id="input_contact_email" name="input_contact_email"
                     ...
                     <div class="col-sm-3">
                        <div class=" btn-group">
                           <button type="button" class="btn btn-outline-primary" id="btn_edit">Editar mi
                              información</button>
                           <button type="submit" class="btn btn-outline-dark d-none rounded-start"
                              id="btn_submit">GUARDAR</button>
                           <button type="button" class="btn btn-outline-danger d-none rounded-end"
                              id="btn_cancel">CANCELAR</button>
                        </div>
                        <button type="button" class="btn btn-outline-info m-2" id="btn_change_password"
                           data-bs-toggle="modal" data-bs-target="#password_modal">Cambiar Contraseña</button>
                     </div>
               ...
               <p class="text-muted text-center">Software Engineer</p> -->
                           ...
                           <div class="mb-3 col">
                              ...
                              <div class="mt-2 d-none im_input">
                                 <label for="input_company_ranking_id" class="form-label">Clasificacón: <span
                                       class="obligatory"></span></label>
                                 <select class="select2 form-control d-none im_input" style="width:100%"
                                    id="input_company_ranking_id" name="input_company_ranking_id"
                                    data-input-name="ACERCA DE">
                                 </select>
                              </div>
                           </div>
                           <div class="mb-3 col">
                              <div class="im_output">
                                 ...
                                 <p class="fw-bolder" id="output_accept_inclusive">[Empresa Inclusiva]
                                 </p>
                              </div>
                              <div class="form-group d-none im_input">
                                 <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input d-none im_input"
                                       id="input_accept_inclusive" name="input_accept_inclusive">
                                    <label class="custom-control-label" id="label_module_enable"
                                       for="input_accept_inclusive">Empresa Inclusiva:</label>
                                    <p>(aceptamos personal con alguna discapacidad)</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           ...
                           <div class="row border rounded-lg">
                              ...
                              <p class="description-header im_output" id="output_email">[correo_de_usuario@gmail.com]
                              </p>
                              <div class="mb-3 d-none im_input">
                                 <label for="input_email " class="form-label">Correo Electronico: <span
                                       class="obligatory"></span></label>
                                 <input class="form-control" id="input_email" name="input_email"
                                    data-input-name="EMAIL DE USUARIO">
                                 </input>
                              </div>
                           </div>
                        </div>
            ...
            <div class="card card-widget widget-user shadow">
               ...
               <div class="widget-user-header bg-dark" id="div_header">
                  <h3 class="widget-user-username im_output">
                     <span id="output_name">[Mi Nombre]</span> - <span class="h6 fst-italic" id="output_birthdate">[Mi
                        edad]</span>
                  </h3>
                  <input type="text" class="form-control-border-white text-white text-center d-none im_input"
                     title="[Enter] para siguiente" id="input_name" name="input_name" data-input-name="NOMBRES">
                  <input type="text" class="form-control-border-white text-white text-center d-none im_input"
                     title="[Enter] para siguiente" id="input_last_name" name="input_last_name"
                     data-input-name="APELLIDOS">
                  <h5 class="im_output">
                     <span class="widget-user-desc im_output" id="output_profession">[Mi Profesión]</span> -
                     <span class="widget-user-desc im_output" id="output_candidate_location">[C.P, Ciudad, Estado]</span>
                  </h5>
                  <div class="mt-2 d-none im_input">
                     <div class="row justify-content-center">
                        ...
                        <!-- <span title="dar click aqui si no se cargan los datos." data-input="input_candidate_state" class="reload_input">&nbsp;&nbsp;<i class="fa-light fa-arrows-rotate pointer"></i></span> -->
                        <select class="select2 form-control" style="width:15vw; line-height:10px"
                           id="input_candidate_state" name="input_candidate_state" data-input-name="ESTADO">
                        </select>
               ...
               <div class="widget-user-image">
                  <label for="input_photo_path">
                     <div id="preview_photo" class="d-flex justify-content-center">
                        <img class="img-circle elevation-2 bg-white pointer-sm opacity-100 d-none" id="output_photo"
                           src="../assets/img/sin_perfil.webp" alt="Foto de perfil" for="input_photo_path"
                           title="Haz clic aquí, si deseas cambiar tu foto de perfil">
                     </div>
                  </label>
               </div>
               <div class="card-footer">
                  <div class="row">
                     <div class="col-sm-3 border-right">
                        <div class="description-block">
                           ...
                           <input type="text" class="form-control-border text-white text-center d-none im_input"
                              title="[Enter] para siguiente" id="input_email" name="input_email" data-input-name="CORREO">
                           <span class="description-text"><i class="fa-solid fa-envelope"></i></span>
                        </div>
                     ...
                     <div class="col-sm-3 border-right">
                        <div class="description-block">
                           ...
                           <input type="text" class="form-control-border text-white text-center d-none im_input"
                              title="[Enter] para siguiente" id="input_cellphone" name="input_cellphone"
                              data-input-name="CELULAR">
                           <span class="description-text"><i class="fa-sharp fa-solid fa-phone"></i></span>
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class=" btn-group">
                           ...
                           <button type="button" class="btn btn-outline-danger d-none rounded-end"
                              id="btn_cancel">CANCELAR</button>
                           <button type="button" class="btn btn-outline-dark" id="btn_change_enable" data-enable=""
                              title=""></button>
                        </div>
                        <button type="button" class="btn btn-outline-info m-2" id="btn_change_password"
                           data-bs-toggle="modal" data-bs-target="#password_modal">Cambiar Contraseña</button>
                        ...
                        <div class="row">
                           <div class="mb-3 col-md-4 border-right">
                              <label for="input_disability_id" class="form-label">¿Cuenta con alguna
                                 Discapacidad?</label>
                              <h5 class="widget-user-desc im_output" id="output_disability">[Discapacidad]</h5>
                              <div class="mt-2 d-none im_input">
                                 <select class="select2 d-none im_input form-select" style="width:100%; line-height:10px"
                           ...
                           <div class="mb-3 col-md-4 border-right">
                              ...
                              <h5 class="widget-user-desc im_output" id="output_gender">[Género]</h5>
                              <div class="mt-2 d-none im_input">
                                 <select class="select2 d-none im_input form-select" style="width:100%; line-height:10px"
                                    id="input_gender" name="input_gender" data-input-name="GÉNERO">
                                 </select>
                              </div>
                           </div>
                           <div class="mb-3 col-md-4">
                              <label for="input_level_id" class="form-label">Nivel de Estudio Máximo:</label>
                              <h5 class="widget-user-desc im_output" id="output_level">[Nivel de Estudio]</h5>
                              <div class="mt-2 d-none im_input">
                                 <select class="select2 d-none im_input form-select" style="width:100%; line-height:10px"
                        ...
                        <label for="input_cv_path" class="">
                           <div id="preview_cv" class="d-flex justify-content-center">
                              <img src="<?= $IMG_PATH ?>/cargar_archivo.png" alt="Cargar CV" id="output_cv"
                                 class="img-fluid pointer-sm p-5 rounded-lg" style="height: 250px !important;"
   ...
   <div class="modal fade" id="password_modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true"
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
         <form class="modal-content" id="form_password" enctype="multipart/form-data">
            ...
            <div class="modal-body">
               <div class="mb-3 row">
                  <div class="col-12">
                     <label for="input_password" class="form-label">Nueva Contraseña: <span
                           class="obligatory"></span></label>
                     <div class="input-icon">
                        <input type="password" class="form-control" id="input_password" name="input_password"
                           data-input-name="NUEVA CONTRASEÑA">
                        <i class="fa-duotone fa-eye-slash eye_icon" data-input="input_password"></i>
                     </div>
                  </div>
                  <div class="col-12">
                     <label for="input_confirm_password" class="form-label">Confirmar Contraseña: <span
                           class="obligatory"></span></label>
                     <div class="input-icon">
                        <input type="password" class="form-control" id="input_confirm_password"
                           name="input_confirm_password" data-input-name="CONFIRMAR CONTRASEÑA">
            ...
            <div class="modal-footer">
               <button type="submit" id="btn_submit_passwrod" class="btn btn-dark fw-bold">ACEPTAR</button>
