...
INSERT INTO `applications` VALUES (1,2,1,'Pendiente',1,'2023-06-06 02:26:52',NULL),(7,1,1,'Pendiente',1,'2023-06-06 03:31:14',NULL);
...
CREATE TABLE `candidates` (
  ...
  `interest_tags_ids` text NOT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_area_id_idx` (`area_id`),
  KEY `fk_candidate_user_idx` (`user_id`),
  CONSTRAINT `fk_candidate_area` FOREIGN KEY (`area_id`) REFERENCES `areas` (`id`) ON UPDATE CASCADE,
...
INSERT INTO `companies` VALUES (1,'Meyer Dennis Traders','Enim irure tota','companies/Meyer Dennis Traders.PNG','Zelda Summers','2131231313','goberegaxe@mailinator.com','Zacatecas','Banon',3,2,1),(2,'Morrison Hester Traders','Culpa expedita ','companies/Morrison Hester Traders.JPEG','Eleanor Massey','5464544646','dasexun@mailinator.com','Chiapas','Acala',4,1,2);
...
CREATE TABLE `menus` (
  ...
  `file_path` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `icon` varchar(50) CHARACTER SET utf8mb4 DEFAULT 'fa-light fa-circle',
...
INSERT INTO `menus` VALUES (1,'Administración',NULL,'admin',0,'#','fa-solid fa-folder-tree',1,1,'2023-05-08 14:00:00',NULL,NULL),(2,'Usuarios',NULL,'users',1,'usuarios.php','fa-light fa-users',1,1,'2023-05-08 14:02:00',NULL,NULL),(3,'Módulos',NULL,'modules',1,'modulos.php','fa-light fa-kaaba',2,1,'2023-05-08 14:03:00','2023-05-17 09:03:28',NULL),(4,'Giros',NULL,'business_lines',1,'giros.php','fa-light fa-briefcase',NULL,1,'2023-05-15 11:38:46','2023-05-17 09:03:46',NULL),(5,'Etiquetas',NULL,'tags',1,'etiquetas.php','fa-light fa-tags',NULL,1,'2023-05-17 07:45:23',NULL,NULL),(6,'Áreas',NULL,'areas',1,'areas.php','fa-light fa-objects-column',NULL,1,'2023-05-17 07:50:08','2023-05-17 08:47:09',NULL),(7,'Clasificaciones de Empresa',NULL,'company_rankigns',1,'clasificaciones-empresa.php','far fa-circle',NULL,1,'2023-05-17 07:56:22',NULL,NULL),(8,'Empresas',NULL,'companies',0,'#','fa-solid fa-buildings',NULL,1,'2023-05-17 09:01:43','2023-05-25 11:57:42',NULL),(9,'Listado',NULL,'companies_list',8,'empresas.php','fa-sharp fa-light fa-list-tree',NULL,1,'2023-05-25 11:57:34','2023-06-06 02:52:09',NULL),(10,'Vacantes',NULL,'vacancies',8,'vacantes.php','fa-light fa-file-lines',NULL,1,'2023-06-01 10:03:35',NULL,NULL),(11,'Candidatos',NULL,'canidates',0,'#','fa-solid fa-user-tie',NULL,1,'2023-06-06 02:49:27','2023-06-06 02:49:50',NULL),(12,'Listado',NULL,'candidates_list',11,'candidatos.php','fa-sharp fa-light fa-list-tree',NULL,1,'2023-06-06 02:51:32','2023-06-06 02:51:48',NULL),(13,'Solicitudes',NULL,'companies_applications',8,'solicitudes.php','fa-light fa-memo-circle-check',NULL,1,'2023-06-06 02:57:46','2023-06-06 02:59:02',NULL),(14,'Mis Solicitudes',NULL,'canidates_applications',11,'solicitudes.php','fa-light fa-memo-circle-check',NULL,1,'2023-06-06 02:58:54',NULL,NULL);
...
CREATE TABLE `roles` (
  `id` int NOT NULL AUTO_INCREMENT,
  `role` varchar(150) CHARACTER SET utf8mb4 NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `pages_read` text CHARACTER SET utf8mb4,
  `pages_write` text CHARACTER SET utf8mb4,
  `pages_update` text CHARACTER SET utf8mb4,
  `pages_delete` text CHARACTER SET utf8mb4,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `roles` VALUES (1,'SuperAdmin',1,'todas','todas','todas','todas','2023-05-08 08:17:54',NULL,NULL),(2,'Administrativo',1,'todas','todas','todas','todas','2023-05-08 08:17:54',NULL,NULL),(3,'Empresa',1,'todas','todas','todas','todas','2023-05-08 08:17:54',NULL,NULL),(4,'Candidato',1,'todas','todas','todas','todas','2023-05-08 08:17:54',NULL,NULL);
...
CREATE TABLE `users` (
  ...
  `cellphone` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Nestor','Puentes','8715151515','nes@gmail.com','$2y$10$L4zA0yzj/cdFSq4RjTDxcOkpwkP9vlCSBfyFQzpw4R0qrECaf38nC',1,1,'2023-05-24 02:45:33','2023-05-25 11:54:17',NULL),(2,'Gustavo','Puentes',NULL,'gustavo@gmail.com','$2y$10$7Dq0czfZyELAu1Hi.337kepGbgqwJjUDUKFxzUMprSaQjDUDR5kqC',1,3,'2023-05-24 03:01:33',NULL,NULL),(3,'Samuel','Garza',NULL,'sam@gmail.com','$2y$10$AU9ZIbk55Io4kfThyijNwua1N3geP7cy2D2hqrvZLq6CY2/fDMYy2',1,NULL,'2023-06-02 02:54:13',NULL,NULL);
...
CREATE TABLE `vacancies` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_vacancy_company_idx` (`company_id`),
  KEY `fk_vacancy_area_idx` (`area_id`),
  CONSTRAINT `fk_vacancy_area` FOREIGN KEY (`area_id`) REFERENCES `areas` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_vacancy_company` FOREIGN KEY (`company_id`) REFERENCES `company_rankings` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-06 16:08:00
